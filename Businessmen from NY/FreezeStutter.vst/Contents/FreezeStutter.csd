...
rslider   bounds( 95, 160, 80, 80), range(0.5, 10,2), channel("RandPitchFreq"), text("Random Pitch Freq")
rslider   bounds( 180, 160, 80, 80), range(0.5, 10,3), channel("RandSizeFreq"), text("Random Size Freq")
